...
<!-- Generated by go run ./tools/migrationledger -write-doc. Do not edit by hand. -->

> Riido task: RIID-4638 `[Control Plane] 기존 riido_ai_server 마이그레이션 계획/문서화`

Executable SSOT: [`control-plane.riido.json`](control-plane.riido.json).
...
| Step | Statement |
| --- | --- |
| Observe | The control-plane migration history was the last registered manual documentation debt and could not prove section coverage without reading a long prose file. |
| Hypothesis | A migration ledger manifest can preserve historical slices while making the reader generated and the remaining migration structure machine-checkable. |
| Execute | Generate the migration reader from this ledger, verify required boundary sections, count migrated slices, and publish evidence in CI. |
| Evaluate | The verifier fails on missing required sections, insufficient slice or validation coverage, stale generated docs, malformed section shapes, or incomplete loop metadata. |
| Retrospective | This removes the final manual documentation surface without deleting historical context; future cleanup can further normalize slice bodies into richer DSL fields. |
