...
| `riido_ai_server_guard` | `internal/riidoaiserver` | 100% | `d9ef4d3f1dfe` | `server_route_handlers_must_stay_semantically_split` |
...
- tracked files: `2950`
- unique syntax hashes: `2762`
- compression gain: `188`
- analysis reduction: `6.37%`
- collision count: `0`
- relocation mappings: `2950`
