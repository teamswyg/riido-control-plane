...
| `baseline_ci_parity_guard` | `tools/ciworkflowparity` | 100% | `cb11cf5a0425` | `operational_readiness_checks_must_bind_release_items_to_evidence` |
