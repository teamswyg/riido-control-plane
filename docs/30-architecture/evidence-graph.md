...
| `control_plane_performance_evidence_loop` | `1` | `11` | `10` | `8` | `closed_loop_candidate` |
| `harness_failure_always_promotion_loop` | `1` | `5` | `4` | `3` | `closed_loop_candidate` |
| `closed_loop_candidate_adoption_plan_loop` | `1` | `9` | `5` | `5` | `closed_loop_candidate_decision` |
...
| `loop_closure_audit_loop` | `1` | `10` | `3` | `2` | `closed_loop_candidate` |
