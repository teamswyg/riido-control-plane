...
| `provider_acceptance_observation_coverage_loop` | `1` | `4` | `3` | `3` | `provider_acceptance_harness` |
...
| `expired_loop_refresh_command_selection_loop` | `1` | `8` | `3` | `2` | `closed_loop_candidate` |
...
| `ambiguous_task_context_thread_interaction_loop` | `1` | `32` | `14` | `1` | `ai_thread_history` |
