...
| `ai_thread_history_conversation_grouping_loop` | `1` | `10` | `4` | `2` | `ai_thread_history` |
...
| `expired_loop_refresh_dispatch_loop` | `1` | `19` | `15` | `3` | `closed_loop_candidate` |
...
| `loop_closure_audit_loop` | `1` | `23` | `7` | `3` | `closed_loop_candidate` |
