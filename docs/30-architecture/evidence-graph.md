...
- complete chains: `139` / `139`
- claim-bound chains: `139`
- unclaimed chains: `0`
- next-loop targets: `9`

| Next Loop | Chains | Claims | Changes | Verifiers | Evidence |
| --- | ---: | ---: | ---: | ---: | ---: |
| `closed_loop_candidate` | `88` | `97` | `1109` | `555` | `286` |
...
| `control_plane_performance_evidence_loop` | `1` | `144` | `61` | `29` | `closed_loop_candidate` |
