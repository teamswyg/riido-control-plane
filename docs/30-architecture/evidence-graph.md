...
| `expired_loop_refresh_dispatch_loop` | `1` | `39` | `21` | `4` | `closed_loop_candidate` |
...
| `loop_registry_target_verifier_plan_loop` | `1` | `33` | `9` | `2` | `closed_loop_candidate` |
| `evidence_graph_chain_impact_loop` | `1` | `13` | `5` | `2` | `closed_loop_candidate` |
