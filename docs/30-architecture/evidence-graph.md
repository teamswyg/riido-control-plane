...
| `control_plane_performance_evidence_loop` | `1` | `52` | `26` | `9` | `closed_loop_candidate` |
...
| `expired_loop_refresh_dispatch_loop` | `1` | `10` | `10` | `2` | `closed_loop_candidate` |
...
| `loop_closure_audit_loop` | `1` | `22` | `7` | `3` | `closed_loop_candidate` |
