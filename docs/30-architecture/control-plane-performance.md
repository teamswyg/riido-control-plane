...
- Evaluate: The verifier fails on missing benchmark coverage, missing local pressure evidence, missing capacity estimates, missing finding-level closed-loop candidate adoption paths, missing pprof loopback contract, missing aiagentload live command, stale generated docs, or non-strict workflow artifacts.
