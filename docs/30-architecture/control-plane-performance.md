...
- architecture query: `go run ./tools/controlplaneperf -architecture-query-path internal/riidoaiserver/http_transaction_metrics_observe.go -architecture-query-path internal/riidoaiserver/server.go -architecture-query-out out/control-plane-architecture-query.json`
...
| File | Components | Hot Paths | Pressure | Signals | Evidence | Target Commands |
| --- | --- | --- | --- | --- | --- | --- |
| `internal/riidoaiserver/ai_agent_client_development_func_filter_unseen_progress_lines.go` | `runtime_progress_fanout` | `client_event_subscriber_fanout, progress_message_rendering` | `allocation, cpu_busy, goroutine_delta, heap_memory, latency` | `agent_thread_progress, cloudwatch_emf, riido.trace.surface` | `control-plane-local-pressure, control-plane-performance-bench, control-plane-pressure-closed-loop-candidates` | `3` |
| `internal/riidoaiserver/ai_agent_client_development_func_merge_thread_progress_lines.go` | `runtime_progress_fanout` | `client_event_subscriber_fanout, progress_message_rendering` | `allocation, cpu_busy, goroutine_delta, heap_memory, latency` | `agent_thread_progress, cloudwatch_emf, riido.trace.surface` | `control-plane-local-pressure, control-plane-performance-bench, control-plane-pressure-closed-loop-candidates` | `3` |
| `internal/riidoaiserver/ai_agent_client_development_func_normalize_progress_lines.go` | `runtime_progress_fanout` | `progress_message_rendering` | `allocation, cpu_busy, goroutine_delta, heap_memory, latency` | `agent_thread_progress, cloudwatch_emf, riido.trace.surface` | `control-plane-local-pressure, control-plane-performance-bench, control-plane-pressure-closed-loop-candidates` | `2` |
| `internal/riidoaiserver/ai_agent_client_development_func_progress_lines_after.go` | `runtime_progress_fanout` | `client_event_subscriber_fanout, progress_message_rendering` | `allocation, cpu_busy, goroutine_delta, heap_memory, latency` | `agent_thread_progress, cloudwatch_emf, riido.trace.surface` | `control-plane-local-pressure, control-plane-performance-bench, control-plane-pressure-closed-loop-candidates` | `3` |
| `internal/riidoaiserver/ai_agent_client_development_method_active_task_thread_stream_targets_locked.go` | `client_http_surface` | `thread_stream_targets` | `allocation, cpu_busy, heap_memory, latency, otel_signal` | `cloudwatch_emf, http.route, riido.trace.surface` | `control-plane-high-traffic-audit, control-plane-local-pressure, control-plane-performance-bench` | `1` |
| `internal/riidoaiserver/ai_agent_client_development_method_append_client_event_locked.go` | `runtime_progress_fanout` | `client_event_subscriber_fanout` | `allocation, cpu_busy, goroutine_delta, heap_memory, latency` | `agent_thread_progress, cloudwatch_emf, riido.trace.surface` | `control-plane-local-pressure, control-plane-performance-bench, control-plane-pressure-closed-loop-candidates` | `1` |
| `internal/riidoaiserver/ai_agent_client_development_method_append_thread_progress_locked.go` | `runtime_progress_fanout` | `client_event_subscriber_fanout, progress_message_rendering` | `allocation, cpu_busy, goroutine_delta, heap_memory, latency` | `agent_thread_progress, cloudwatch_emf, riido.trace.surface` | `control-plane-local-pressure, control-plane-performance-bench, control-plane-pressure-closed-loop-candidates` | `3` |
| `internal/riidoaiserver/ai_agent_client_development_method_record_ai_agent_thread_progress.go` | `runtime_progress_fanout` | `progress_message_rendering` | `allocation, cpu_busy, goroutine_delta, heap_memory, latency` | `agent_thread_progress, cloudwatch_emf, riido.trace.surface` | `control-plane-local-pressure, control-plane-performance-bench, control-plane-pressure-closed-loop-candidates` | `2` |
| `internal/riidoaiserver/ai_agent_client_development_method_subscribe_ai_agent_client_events.go` | `runtime_progress_fanout` | `client_event_subscriber_fanout` | `allocation, cpu_busy, goroutine_delta, heap_memory, latency` | `agent_thread_progress, cloudwatch_emf, riido.trace.surface` | `control-plane-local-pressure, control-plane-performance-bench, control-plane-pressure-closed-loop-candidates` | `1` |
| `internal/riidoaiserver/ai_agent_client_development_method_visible_task_threads_locked.go` | `client_http_surface` | `thread_stream_targets` | `allocation, cpu_busy, heap_memory, latency, otel_signal` | `cloudwatch_emf, http.route, riido.trace.surface` | `control-plane-high-traffic-audit, control-plane-local-pressure, control-plane-performance-bench` | `1` |
| `internal/riidoaiserver/ai_agent_client_development_thread_progress_lookup.go` | `runtime_progress_fanout` | `client_event_subscriber_fanout, progress_message_rendering` | `allocation, cpu_busy, goroutine_delta, heap_memory, latency` | `agent_thread_progress, cloudwatch_emf, riido.trace.surface` | `control-plane-local-pressure, control-plane-performance-bench, control-plane-pressure-closed-loop-candidates` | `3` |
| `internal/riidoaiserver/ai_agent_client_thread_progress_retention_test.go` | `runtime_progress_fanout` | `client_event_subscriber_fanout, progress_message_rendering` | `allocation, cpu_busy, goroutine_delta, heap_memory, latency` | `agent_thread_progress, cloudwatch_emf, riido.trace.surface` | `control-plane-local-pressure, control-plane-performance-bench, control-plane-pressure-closed-loop-candidates` | `3` |
| `internal/riidoaiserver/dynamodb_assignment_operation_store_claim_api.go` | `store_assignment_scheduler` | `` | `allocation, goroutine_delta, latency, otel_signal, race_condition` | `aws.operation, riido.store.operation, xray_subsegment` | `control-plane-local-pressure, control-plane-pressure-closed-loop-candidates, control-plane-race` | `0` |
| `internal/riidoaiserver/http_transaction_metrics_observe.go` | `bounded_observability_metrics` | `http_transaction_metrics` | `allocation, cpu_busy, heap_memory, otel_signal` | `aws.operation, cloudwatch_emf, http.route, riido.store.operation` | `control-plane-high-traffic-audit, control-plane-performance-bench, control-plane-performance-evidence` | `1` |
| `internal/riidoaiserver/http_transaction_metrics_snapshot.go` | `bounded_observability_metrics` | `http_transaction_metrics` | `allocation, cpu_busy, heap_memory, otel_signal` | `aws.operation, cloudwatch_emf, http.route, riido.store.operation` | `control-plane-high-traffic-audit, control-plane-performance-bench, control-plane-performance-evidence` | `1` |
| `internal/riidoaiserver/metrics_window.go` | `bounded_observability_metrics` | `` | `allocation, cpu_busy, heap_memory, otel_signal` | `aws.operation, cloudwatch_emf, http.route, riido.store.operation` | `control-plane-high-traffic-audit, control-plane-performance-bench, control-plane-performance-evidence` | `0` |
| `internal/riidoaiserver/progress_messages_render.go` | `runtime_progress_fanout` | `progress_message_rendering` | `allocation, cpu_busy, goroutine_delta, heap_memory, latency` | `agent_thread_progress, cloudwatch_emf, riido.trace.surface` | `control-plane-local-pressure, control-plane-performance-bench, control-plane-pressure-closed-loop-candidates` | `2` |
| `internal/riidoaiserver/server_ai_agent_client_task_v3.go` | `client_http_surface` | `` | `allocation, cpu_busy, heap_memory, latency, otel_signal` | `cloudwatch_emf, http.route, riido.trace.surface` | `control-plane-high-traffic-audit, control-plane-local-pressure, control-plane-performance-bench` | `0` |
| `internal/riidoaiserver/server_client_sse.go` | `client_http_surface` | `` | `allocation, cpu_busy, heap_memory, latency, otel_signal` | `cloudwatch_emf, http.route, riido.trace.surface` | `control-plane-high-traffic-audit, control-plane-local-pressure, control-plane-performance-bench` | `0` |
| `internal/riidoaiserver/server_handler.go` | `client_http_surface` | `` | `allocation, cpu_busy, heap_memory, latency, otel_signal` | `cloudwatch_emf, http.route, riido.trace.surface` | `control-plane-high-traffic-audit, control-plane-local-pressure, control-plane-performance-bench` | `0` |
| `internal/riidoaiserver/server_json.go` | `client_http_surface` | `` | `allocation, cpu_busy, heap_memory, latency, otel_signal` | `cloudwatch_emf, http.route, riido.trace.surface` | `control-plane-high-traffic-audit, control-plane-local-pressure, control-plane-performance-bench` | `0` |
| `internal/riidoaiserver/store_operation_metrics_observe.go` | `bounded_observability_metrics, store_assignment_scheduler` | `store_operation_metrics` | `allocation, cpu_busy, goroutine_delta, heap_memory, latency, otel_signal, race_condition` | `aws.operation, cloudwatch_emf, http.route, riido.store.operation, xray_subsegment` | `control-plane-high-traffic-audit, control-plane-local-pressure, control-plane-performance-bench, control-plane-performance-evidence, control-plane-pressure-closed-loop-candidates, control-plane-race` | `1` |
...
| `internal/riidoaiserver/store_waiter_handlers.go` | `waiter_and_tool_approval_lifecycle` | `` | `cpu_busy, goroutine_delta, latency, race_condition` | `assignment_poll_wait, cloudwatch_emf, tool_approval_wait` | `control-plane-high-traffic-audit, control-plane-local-pressure, control-plane-race` | `0` |
| `internal/riidoaiserver/tool_approval_http.go` | `waiter_and_tool_approval_lifecycle` | `tool_approval_waiters` | `cpu_busy, goroutine_delta, latency, race_condition` | `assignment_poll_wait, cloudwatch_emf, tool_approval_wait` | `control-plane-high-traffic-audit, control-plane-local-pressure, control-plane-race` | `1` |
...
- Evaluate: The verifier fails on missing benchmark coverage, missing race artifact wiring, missing local pressure evidence, missing capacity estimates, missing local pressure candidate artifact, missing local pprof command/profile metadata path, missing finding-level closed-loop candidate adoption paths, missing pprof loopback contract, missing aiagentload live command, stale generated docs, non-strict workflow artifacts, architecture queries that omit match_kind, component summaries, direct/fallback hit counts, or aiagentload tests that lose throughput/capacity/resource/pprof fields.
