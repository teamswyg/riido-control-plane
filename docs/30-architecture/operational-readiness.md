...
| `notion_p0_completion_progress_after_terminal` | `partial` | `[codex][계획중][증적요청]` | `staging_client_p0_visual_retest` | `completion_progress_same_conversation_network_snapshot` |
...
| `2026-06-30` | `usability` | `partial` | `staging_client_p0_visual_retest` | `21` | `18` | `staging_client_p0_visual_screenshot_evidence` |
