...
| `notion_p0_completion_progress_after_terminal` | `partial` | `[codex][진행중][부분증적]` | `staging_client_p0_visual_retest` | `reproduced_completion_progress_same_conversation_network_snapshot` |
...
| `2026-06-30` | `usability` | `partial` | `staging_client_p0_visual_retest` | `28` | `31` | `staging_client_p0_visual_screenshot_evidence` |
...
| `2026-06-26` | `stress` | `covered` | `testnet_load_capacity` | `18` | `26` | `capacity_result_annotation` |
