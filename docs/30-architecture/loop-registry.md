...
| `load_harness_failures_must_promote_candidates` | `ai_agent_load_harness` | `8` | `3` | `82b2111f506c` |
| `control_plane_performance_hot_paths_must_emit_evidence` | `control_plane_performance_harness` | `134` | `45` | `bd40755cd902` |
| `control_plane_meta_evidence_must_self_expire` | `control_plane_performance_harness` | `10` | `4` | `06c3f31f9fbc` |
...
| `closed_loop_candidates_must_carry_promotion_edge` | `closed_loop_candidate` | `28` | `9` | `18218cdc9433` |
| `closed_loop_candidates_must_carry_source_ref` | `closed_loop_candidate` | `22` | `6` | `bf7236d51597` |
| `closed_loop_candidates_must_carry_subject` | `closed_loop_candidate` | `18` | `4` | `4bb21f9df11b` |
| `loop_verifiers_must_accept_verify_intent` | `closed_loop_candidate` | `16` | `10` | `299959a31e62` |
| `loop_evidence_artifacts_must_have_refresh_owners` | `closed_loop_candidate` | `10` | `3` | `9171d2c26c73` |
| `ambiguous_task_context_must_ask_before_work` | `ai_thread_history` | `85` | `31` | `f1642d8b10a3` |
| `claim_surface_evidence_must_expose_code_test_doc_binding` | `closed_loop_candidate` | `17` | `7` | `0deaf914b3e5` |
| `loop_registry_evidence_must_expose_loop_surfaces` | `closed_loop_candidate` | `5` | `1` | `f7a414b361eb` |
| `loop_registry_evidence_must_expose_architecture_index` | `closed_loop_candidate` | `16` | `7` | `97a94efa9ba4` |
| `loop_registry_impact_must_expose_target_verifier_plan` | `closed_loop_candidate` | `56` | `29` | `871459adf200` |
| `loop_coverage_dimensions_must_use_static_registry` | `closed_loop_candidate` | `20` | `7` | `ff1013dbcaee` |
...
| `evidence_graph_must_cover_loop_registry_claims` | `closed_loop_candidate` | `10` | `4` | `fa72f476538e` |
| `evidence_graph_refs_must_trigger_evidence_workflow` | `closed_loop_candidate` | `6` | `4` | `8480fbce71d5` |
| `evidence_graph_evidence_must_expose_full_chain` | `closed_loop_candidate` | `9` | `3` | `14a32c8730ac` |
...
| `closed_loop_candidate_consumers_must_reject_expired_candidates` | `closed_loop_candidate` | `13` | `4` | `94c7d2c12a50` |
...
| `operational_readiness_checks_must_bind_release_items_to_evidence` | `operational_readiness_release_harness` | `67` | `29` | `5345aa5092bd` |
