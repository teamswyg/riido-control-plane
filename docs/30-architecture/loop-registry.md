...
| `load_harness_failures_must_promote_candidates` | `ai_agent_load_harness` | `8` | `3` | `ffc76ab5d55f` |
| `control_plane_performance_hot_paths_must_emit_evidence` | `control_plane_performance_harness` | `134` | `45` | `bd40755cd902` |
| `control_plane_meta_evidence_must_self_expire` | `control_plane_performance_harness` | `10` | `4` | `cd7a7dc392b2` |
...
| `closed_loop_candidates_must_carry_promotion_edge` | `closed_loop_candidate` | `28` | `9` | `1ac2b4a3ffb0` |
| `closed_loop_candidates_must_carry_source_ref` | `closed_loop_candidate` | `22` | `6` | `800b695896be` |
| `closed_loop_candidates_must_carry_subject` | `closed_loop_candidate` | `18` | `4` | `bfae66f5b20a` |
| `loop_verifiers_must_accept_verify_intent` | `closed_loop_candidate` | `16` | `10` | `9a894bd7ba30` |
| `loop_evidence_artifacts_must_have_refresh_owners` | `closed_loop_candidate` | `10` | `3` | `cc4bd20b82ea` |
| `ambiguous_task_context_must_ask_before_work` | `ai_thread_history` | `85` | `31` | `f1642d8b10a3` |
| `claim_surface_evidence_must_expose_code_test_doc_binding` | `closed_loop_candidate` | `17` | `7` | `23f0f73a2bad` |
| `loop_registry_evidence_must_expose_loop_surfaces` | `closed_loop_candidate` | `5` | `1` | `f7a414b361eb` |
| `loop_registry_evidence_must_expose_architecture_index` | `closed_loop_candidate` | `16` | `7` | `7d20c6bfd767` |
| `loop_registry_impact_must_expose_target_verifier_plan` | `closed_loop_candidate` | `56` | `29` | `1fa1aa9ebdfe` |
| `loop_coverage_dimensions_must_use_static_registry` | `closed_loop_candidate` | `20` | `7` | `e8789e405ef0` |
...
| `evidence_graph_must_cover_loop_registry_claims` | `closed_loop_candidate` | `10` | `4` | `7e791eaaec88` |
| `evidence_graph_refs_must_trigger_evidence_workflow` | `closed_loop_candidate` | `6` | `4` | `adcc54577fff` |
| `evidence_graph_evidence_must_expose_full_chain` | `closed_loop_candidate` | `9` | `3` | `9240cdc20f14` |
...
| `closed_loop_candidate_consumers_must_reject_expired_candidates` | `closed_loop_candidate` | `13` | `4` | `e0266b4d9e5a` |
...
| `operational_readiness_checks_must_bind_release_items_to_evidence` | `operational_readiness_release_harness` | `67` | `29` | `ee6f328ab73d` |
