...
| `load_harness_failures_must_promote_candidates` | `ai_agent_load_harness` | `8` | `3` | `80dc0352aca1` |
| `control_plane_performance_hot_paths_must_emit_evidence` | `control_plane_performance_harness` | `134` | `45` | `bd40755cd902` |
| `control_plane_meta_evidence_must_self_expire` | `control_plane_performance_harness` | `10` | `4` | `327034f0cbd8` |
| `harness_promotion_must_run_after_failure` | `closed_loop_candidate` | `17` | `9` | `988582040291` |
| `generated_endpoint_smoke_matrix_must_remain_contract_gate` | `closed_loop_candidate` | `7` | `8` | `59f331ebd0d8` |
| `loop_closure_audit_must_prove_human_exit_requirements` | `loop_closure_audit` | `67` | `33` | `87d0eda385fe` |
| `closed_loop_candidates_must_carry_adoption_plan` | `closed_loop_candidate` | `24` | `6` | `d770dceeb879` |
| `closed_loop_candidates_must_carry_promotion_edge` | `closed_loop_candidate` | `28` | `9` | `4257b180630b` |
| `closed_loop_candidates_must_carry_source_ref` | `closed_loop_candidate` | `22` | `6` | `666033372b46` |
| `closed_loop_candidates_must_carry_subject` | `closed_loop_candidate` | `18` | `4` | `fe9f495c017d` |
| `loop_verifiers_must_accept_verify_intent` | `closed_loop_candidate` | `16` | `10` | `9a894bd7ba30` |
| `loop_evidence_artifacts_must_have_refresh_owners` | `closed_loop_candidate` | `10` | `3` | `2bcf8d437851` |
| `ambiguous_task_context_must_ask_before_work` | `ai_thread_history` | `85` | `31` | `f1642d8b10a3` |
| `claim_surface_evidence_must_expose_code_test_doc_binding` | `closed_loop_candidate` | `17` | `7` | `a484cd818f10` |
| `loop_registry_evidence_must_expose_loop_surfaces` | `closed_loop_candidate` | `5` | `1` | `f7a414b361eb` |
| `loop_registry_evidence_must_expose_architecture_index` | `closed_loop_candidate` | `16` | `7` | `225d77ffe0a7` |
| `loop_registry_impact_must_expose_target_verifier_plan` | `closed_loop_candidate` | `56` | `29` | `3988dbb2b67a` |
| `loop_coverage_dimensions_must_use_static_registry` | `closed_loop_candidate` | `20` | `7` | `4fe02bcf2c78` |
...
| `loop_evidence_kinds_must_use_vocabulary` | `closed_loop_candidate` | `7` | `3` | `3c9b0da466bc` |
...
| `pre_commit_must_run_evidence_graph_impact` | `closed_loop_candidate` | `8` | `4` | `daae95ba578b` |
...
| `evidence_graph_must_cover_loop_registry_claims` | `closed_loop_candidate` | `10` | `4` | `3da4288d92ee` |
| `evidence_graph_refs_must_trigger_evidence_workflow` | `closed_loop_candidate` | `6` | `4` | `37c24a58be01` |
| `evidence_graph_evidence_must_expose_full_chain` | `closed_loop_candidate` | `9` | `3` | `eac8d405e9ab` |
...
| `closed_loop_candidate_evidence_must_self_expire` | `closed_loop_candidate` | `12` | `3` | `6948d375ccc0` |
| `closed_loop_candidate_consumers_must_reject_expired_candidates` | `closed_loop_candidate` | `13` | `4` | `2b38cf7e7152` |
...
| `expired_loop_refresh_commands_must_dispatch_safe_workflows` | `closed_loop_candidate` | `66` | `38` | `16eb7c5ed47f` |
...
| `candidate_decisions_must_match_consumed_candidates` | `closed_loop_candidate_decision` | `33` | `12` | `62e68c844a72` |
| `candidate_decision_next_artifact_must_be_required` | `closed_loop_candidate_decision` | `16` | `6` | `063d5c6c2921` |
| `candidate_decision_evidence_must_expose_next_command` | `closed_loop_candidate_decision` | `26` | `13` | `2058ff2c27f9` |
| `open_decision_questions_must_bind_owner_next_artifact_and_reader` | `open_decision_queue` | `8` | `3` | `e362d54b6f38` |
| `operational_readiness_checks_must_bind_release_items_to_evidence` | `operational_readiness_release_harness` | `67` | `29` | `ae22847e34ee` |
