...
| `load_harness_failures_must_promote_candidates` | `ai_agent_load_harness` | `8` | `3` | `0544cfb0fc45` |
| `control_plane_performance_hot_paths_must_emit_evidence` | `control_plane_performance_harness` | `134` | `45` | `bd40755cd902` |
| `control_plane_meta_evidence_must_self_expire` | `control_plane_performance_harness` | `10` | `4` | `10455e119b31` |
...
| `closed_loop_candidates_must_carry_adoption_plan` | `closed_loop_candidate` | `24` | `6` | `6f92f814ee9f` |
| `closed_loop_candidates_must_carry_promotion_edge` | `closed_loop_candidate` | `28` | `9` | `3105912407ca` |
| `closed_loop_candidates_must_carry_source_ref` | `closed_loop_candidate` | `22` | `6` | `3e8554d3a4a3` |
| `closed_loop_candidates_must_carry_subject` | `closed_loop_candidate` | `18` | `4` | `2056b1f2d3ab` |
| `loop_verifiers_must_accept_verify_intent` | `closed_loop_candidate` | `16` | `10` | `9a894bd7ba30` |
| `loop_evidence_artifacts_must_have_refresh_owners` | `closed_loop_candidate` | `10` | `3` | `7c02e3d5e09b` |
| `ambiguous_task_context_must_ask_before_work` | `ai_thread_history` | `85` | `31` | `f1642d8b10a3` |
| `claim_surface_evidence_must_expose_code_test_doc_binding` | `closed_loop_candidate` | `17` | `7` | `2692180083d5` |
| `loop_registry_evidence_must_expose_loop_surfaces` | `closed_loop_candidate` | `5` | `1` | `f7a414b361eb` |
| `loop_registry_evidence_must_expose_architecture_index` | `closed_loop_candidate` | `16` | `7` | `d4979c7a980f` |
| `loop_registry_impact_must_expose_target_verifier_plan` | `closed_loop_candidate` | `56` | `29` | `cd5ddc0a73f8` |
| `loop_coverage_dimensions_must_use_static_registry` | `closed_loop_candidate` | `20` | `7` | `bc22d0e93614` |
...
| `evidence_graph_must_cover_loop_registry_claims` | `closed_loop_candidate` | `10` | `4` | `3beb1eb126da` |
| `evidence_graph_refs_must_trigger_evidence_workflow` | `closed_loop_candidate` | `6` | `4` | `50776697a240` |
| `evidence_graph_evidence_must_expose_full_chain` | `closed_loop_candidate` | `9` | `3` | `c4fcbe512e4e` |
...
| `closed_loop_candidate_evidence_must_self_expire` | `closed_loop_candidate` | `12` | `3` | `bb8e1dcd9c21` |
| `closed_loop_candidate_consumers_must_reject_expired_candidates` | `closed_loop_candidate` | `13` | `4` | `b568d1698e9c` |
...
| `expired_loop_refresh_commands_must_dispatch_safe_workflows` | `closed_loop_candidate` | `66` | `38` | `61624ab8b4df` |
...
| `candidate_decisions_must_match_consumed_candidates` | `closed_loop_candidate_decision` | `33` | `12` | `7e3c88b8e49f` |
| `candidate_decision_next_artifact_must_be_required` | `closed_loop_candidate_decision` | `16` | `6` | `a7534bebe54c` |
| `candidate_decision_evidence_must_expose_next_command` | `closed_loop_candidate_decision` | `26` | `13` | `91858a703704` |
| `open_decision_questions_must_bind_owner_next_artifact_and_reader` | `open_decision_queue` | `8` | `3` | `e362d54b6f38` |
| `operational_readiness_checks_must_bind_release_items_to_evidence` | `operational_readiness_release_harness` | `67` | `29` | `e17fac809d62` |
