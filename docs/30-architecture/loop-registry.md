...
| `load_harness_failures_must_promote_candidates` | `ai_agent_load_harness` | `8` | `3` | `5a2269164a3d` |
...
| `closed_loop_candidates_must_carry_promotion_edge` | `closed_loop_candidate` | `20` | `5` | `654ccc9e4f8d` |
| `loop_verifiers_must_accept_verify_intent` | `closed_loop_candidate` | `10` | `5` | `3f326072ec1c` |
| `loop_evidence_artifacts_must_have_refresh_owners` | `closed_loop_candidate` | `10` | `3` | `a8f4bfcf63d7` |
| `ambiguous_task_context_must_ask_before_work` | `ai_thread_history` | `49` | `18` | `bebf5ac1a6c6` |
| `claim_surface_evidence_must_expose_code_test_doc_binding` | `closed_loop_candidate` | `17` | `7` | `0a538168b34c` |
| `claim_verifier_commands_must_surface_as_ci_annotations` | `closed_loop_candidate` | `7` | `3` | `38af5b95d870` |
| `claim_meaning_changes_require_code_or_test_surface` | `closed_loop_candidate` | `13` | `6` | `f934ccc369f8` |
| `claim_meaning_changes_require_reasoning_chain` | `closed_loop_candidate` | `4` | `2` | `ec7e4ea26666` |
...
| `evidence_graph_must_cover_loop_registry_claims` | `closed_loop_candidate` | `7` | `3` | `66c1d6c37b21` |
| `evidence_graph_refs_must_trigger_evidence_workflow` | `closed_loop_candidate` | `6` | `4` | `9a7f1058a7e8` |
| `evidence_graph_evidence_must_expose_full_chain` | `closed_loop_candidate` | `4` | `2` | `2e3910c1246a` |
...
| `claim_meaning_changes_require_code_or_test_surface` | `7` | `5` | `1` | `2` | `6` | `1` | `1` |
