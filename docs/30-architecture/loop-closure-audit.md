...
| `harness_failures_promote_to_closed_loop` | `verified` | `6` | `6` | Harnesses increase exploration space, and failures must become closed-loop candidates instead of isolated artifacts. |
