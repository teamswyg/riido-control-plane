...
| `harness_failures_promote_to_closed_loop` | `verified` | `8` | `8` | Harnesses increase exploration space, and failures must become closed-loop candidates instead of isolated artifacts. |
