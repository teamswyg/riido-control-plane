...
Packages: `62`; runtime: `1`; internal: `3`; tools: `57`; forbidden import hits: `0`.
...
- `adapter`: `tools/dependencyallowlist/layers`, `tools/integrationmatrix/pathutil`, `tools/openquestions/pathutil`, `tools/repositoryreadme/pathutil`
