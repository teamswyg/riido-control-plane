...
Packages: `44`; runtime: `1`; internal: `3`; tools: `39`; forbidden import hits: `0`.
...
- `meta-evidence-tool`: `tools/gocibaseline`, `tools/knowledgecoverage`, `tools/liveworkflowevidence`, `tools/loopregistry`, `tools/moduledecomposition`, `tools/repositoryreadme`, `tools/workflowevidence`
