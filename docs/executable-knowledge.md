...
| Class | Count |
| --- | ---: |
| Generated reader docs | 1 |
| Direct SSOT docs | 3 |
| Registered manual docs | 16 |
| Scanned docs | 20 |
...
| --- | --- | --- | ---: |
| `domain-manual-debt` | control-plane-domain | domain-specific .riido.json manifests | 8 |
...
| Group | Path |
| --- | --- |
| `domain-manual-debt` | `docs/20-domain/agent-catalog-rbac.md` |
