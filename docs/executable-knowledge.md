...
| Class | Count |
| --- | ---: |
| Generated reader docs | 6 |
| Direct SSOT docs | 3 |
| Registered manual docs | 11 |
| Scanned docs | 20 |
...
| --- | --- | --- | ---: |
| `domain-manual-debt` | control-plane-domain | domain-specific .riido.json manifests | 3 |
...
| `domain-manual-debt` | `docs/20-domain/request-authorization.md` |
