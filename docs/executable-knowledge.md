...
| Generated reader docs with tool | 38 |
| Generated reader docs with CI evidence | 38 |
| Generated reader docs with declared workflow evidence | 38 |
| Generated reader docs with manifest evidence_tool | 8 |
| Generated reader docs with uploaded evidence artifact | 38 |
| Direct SSOT docs | 0 |
...
| Executable manifest inventory | 52 |
| Tracked executable manifests | 52 |
...
| --- | ---: | --- |
| `docs` | 44 | `docs/20-domain/agent-catalog-rbac.riido.json`<br>`docs/20-domain/agent-runtime-binding.riido.json`<br>`docs/20-domain/ai-agent-client-api.riido.json` |
...
- Complete manifest loops: `52`
- Direct manifest loops: `41`
