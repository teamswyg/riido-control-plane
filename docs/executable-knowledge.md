...
| Generated reader docs with tool | 33 |
| Generated reader docs with CI evidence | 33 |
| Generated reader docs with declared workflow evidence | 33 |
| Generated reader docs with manifest evidence_tool | 3 |
| Generated reader docs with uploaded evidence artifact | 33 |
| Direct SSOT docs | 0 |
...
| Executable manifest inventory | 47 |
| Tracked executable manifests | 47 |
...
| --- | ---: | --- |
| `docs` | 39 | `docs/20-domain/agent-catalog-rbac.riido.json`<br>`docs/20-domain/agent-runtime-binding.riido.json`<br>`docs/20-domain/ai-agent-client-api.riido.json` |
...
- Complete manifest loops: `47`
- Direct manifest loops: `36`
