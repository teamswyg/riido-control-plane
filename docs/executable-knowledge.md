...
| --- | --- | --- | ---: |
| `domain-manual-debt` | control-plane-domain | domain-specific .riido.json manifests | 6 |
...
| `domain-manual-debt` | `docs/20-domain/assignment-operation-journal.md` |
