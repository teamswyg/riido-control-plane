...
| Class | Count |
| --- | ---: |
| Generated reader docs | 37 |
| Generated reader docs with tool | 37 |
| Generated reader docs with CI evidence | 37 |
| Generated reader docs with declared workflow evidence | 37 |
| Generated reader docs with manifest evidence_tool | 7 |
| Generated reader docs with uploaded evidence artifact | 37 |
| Direct SSOT docs | 0 |
...
| Executable manifest inventory | 51 |
| Tracked executable manifests | 51 |
...
| --- | ---: | --- |
| `docs` | 43 | `docs/20-domain/agent-catalog-rbac.riido.json`<br>`docs/20-domain/agent-runtime-binding.riido.json`<br>`docs/20-domain/ai-agent-client-api.riido.json` |
...
- Complete manifest loops: `51`
- Direct manifest loops: `40`
