...
| Class | Count |
| --- | ---: |
| Generated reader docs | 36 |
| Generated reader docs with tool | 36 |
| Generated reader docs with CI evidence | 36 |
| Generated reader docs with declared workflow evidence | 36 |
| Generated reader docs with manifest evidence_tool | 6 |
| Generated reader docs with uploaded evidence artifact | 36 |
| Direct SSOT docs | 0 |
...
| Executable manifest inventory | 50 |
| Tracked executable manifests | 50 |
...
| --- | ---: | --- |
| `docs` | 42 | `docs/20-domain/agent-catalog-rbac.riido.json`<br>`docs/20-domain/agent-runtime-binding.riido.json`<br>`docs/20-domain/ai-agent-client-api.riido.json` |
...
- Complete manifest loops: `50`
- Direct manifest loops: `39`
