...
type ComplexityRoot struct {
	Query struct {
		FireError   func(childComplexity int) int
...
type QueryResolver interface {
	FireError(ctx context.Context) (*model.FireErrorVoid, error)
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Query.fireError":
		if e.ComplexityRoot.Query.FireError == nil {
			break
		}

		return e.ComplexityRoot.Query.FireError(childComplexity), true
...
var sources = []*ast.Source{
	{Name: "../../../contracts/nonwork17-owner-schema/owner-schema.graphqls", Input: `scalar ControlPlaneFireErrorVoid
...
func (ec *executionContext) _Query_fireError(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Query_fireError(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			return ec.Resolvers.Query().FireError(ctx)
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *model.FireErrorVoid) graphql.Marshaler {
			return ec.marshalOControlPlaneFireErrorVoid2ᚖgithubᚗcomᚋteamswygᚋriidoᚑcontrolᚑplaneᚋinternalᚋcontrolplanegraphqlᚋmodelᚐFireErrorVoid(ctx, selections, v)
		},
		true,
		false,
	)
}
func (ec *executionContext) fieldContext_Query_fireError(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("Query", field, true, true, errors.New("field of type ControlPlaneFireErrorVoid does not have child fields"))
}
	...
	for i, field := range fields {
		...
		case "fireError":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Query_fireError(ctx, field)
...
func (ec *executionContext) unmarshalOControlPlaneFireErrorVoid2ᚖgithubᚗcomᚋteamswygᚋriidoᚑcontrolᚑplaneᚋinternalᚋcontrolplanegraphqlᚋmodelᚐFireErrorVoid(ctx context.Context, v any) (*model.FireErrorVoid, error) {
	if v == nil {
		return nil, nil
	}
	var res = new(model.FireErrorVoid)
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalOControlPlaneFireErrorVoid2ᚖgithubᚗcomᚋteamswygᚋriidoᚑcontrolᚑplaneᚋinternalᚋcontrolplanegraphqlᚋmodelᚐFireErrorVoid(ctx context.Context, sel ast.SelectionSet, v *model.FireErrorVoid) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return v
