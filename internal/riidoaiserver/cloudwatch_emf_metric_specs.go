...
func cloudWatchMetricSpecs() []cloudWatchMetricSpec {
	specs := []cloudWatchMetricSpec{
		...
		{Name: "sse_streams_active", Unit: "Count"},
		{Name: "sse_streams_opened_total", Unit: "Count"},
		{Name: "sse_streams_closed_total", Unit: "Count"},
		{Name: "sse_stream_ttfb_samples_total", Unit: "Count"},
		{Name: "sse_stream_ttfb_total_ms", Unit: "Milliseconds"},
		{Name: "sse_stream_ttfb_max_ms", Unit: "Milliseconds"},
		{Name: "sse_stream_ttfb_last_ms", Unit: "Milliseconds"},
		{Name: "sse_stream_duration_samples_total", Unit: "Count"},
		{Name: "sse_stream_duration_total_ms", Unit: "Milliseconds"},
		{Name: "sse_stream_duration_max_ms", Unit: "Milliseconds"},
		{Name: "sse_stream_duration_last_ms", Unit: "Milliseconds"},
		...
		{Name: "http_requests_daemon_total", Unit: "Count"},
		{Name: "http_requests_client_app_total", Unit: "Count"},
		{Name: "http_requests_desktop_total", Unit: "Count"},
		{Name: "http_requests_desktop_candidate_total", Unit: "Count"},
		{Name: "http_requests_component_integration_total", Unit: "Count"},
		{Name: "http_requests_unknown_surface_total", Unit: "Count"},
