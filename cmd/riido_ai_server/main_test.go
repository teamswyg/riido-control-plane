...
func clearRiidoAIServerEnv(t *testing.T) {
	...
	for _, key := range []string{
		...
		envPprofAddr,
		envTracingEnabled,
		envTracingSampleRatio,
		envTracingOTLPEndpoint,
		envTracingServiceName,
		envWebAllowedOrigins,
		envAssignmentActiveLease,
		envAIAgentClientDev,
		envAIAgentClientTable,
		envAIAgentClientSnapshotReload,
		envAIAgentClientHeartbeatSave,
		...
		envLongPollMaxHoldSeconds,
		envLongPollTickSeconds,
