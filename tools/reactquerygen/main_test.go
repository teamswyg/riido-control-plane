...
func TestGenerateReactQueryClientIncludesAIAgentSurface(t *testing.T) {
	...
	for _, required := range []string{
		...
		"/v1/client/ai-agent/devices/${params.device_id}/daemon",
		"export interface AIAgentTaskThreadCollectionResponse",
		"export interface DeviceDaemonRecord",
		"export function getAIAgentDeviceDaemonQueryOptions",
		"export function restartAIAgentDeviceDaemonMutationOptions",
