...
type proofSurface struct {
	...
	HarnessCount              int      `json:"harness_count,omitempty"`
	HarnessLoops              []string `json:"harness_loops,omitempty"`
	HarnessCandidateArtifacts []string `json:"harness_candidate_artifacts,omitempty"`
}
