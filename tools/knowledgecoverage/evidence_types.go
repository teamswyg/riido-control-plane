...
type evidence struct {
	...
	SourceManifestMetadataCount      int                `json:"source_manifest_metadata_count"`
	...
	ManifestInventorySamples         []manifestSample   `json:"manifest_inventory_samples"`
	...
	ManifestMissingLoopByGroup       []manifestDir      `json:"manifest_missing_loop_by_group"`
	ManifestMissingLoopSamples       []manifestSample   `json:"manifest_missing_loop_samples"`
	...
	SourceMissingMetadata            []string           `json:"source_manifest_missing_metadata"`
