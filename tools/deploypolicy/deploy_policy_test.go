...
func TestDeployAIAgentTestnetPublicRedactionPolicy(t *testing.T) {
	...
	requireContains(t, workflow, "FORCE_JAVASCRIPT_ACTIONS_TO_NODE24: true")
...
func TestRuntimeCDOwnershipManifest(t *testing.T) {
	...
	requireNonCDRuntimeKey(t, parsed.PublicSensitiveSurfaceGuard.AllowedPublicNonCDRuntime, "RIIDO_AI_SERVER_AGENT_PROFILE_THUMBNAIL_BUCKET", "not a deploy/smoke GitHub configuration key")
	requireNonCDRuntimeKey(t, parsed.PublicSensitiveSurfaceGuard.AllowedPublicNonCDRuntime, "RIIDO_AI_SERVER_AGENT_PROFILE_THUMBNAIL_PREFIX", "not a deploy/smoke GitHub configuration key")
	requireNonCDRuntimeKey(t, parsed.PublicSensitiveSurfaceGuard.AllowedPublicNonCDRuntime, "RIIDO_AI_SERVER_AGENT_PROFILE_THUMBNAIL_CDN_BASE_URL", "not a deploy/smoke GitHub configuration key")
	requireNonCDRuntimeKey(t, parsed.PublicSensitiveSurfaceGuard.AllowedPublicNonCDRuntime, "RIIDO_AI_SERVER_AGENT_PROFILE_THUMBNAIL_MAX_BYTES", "not a deploy/smoke GitHub configuration key")
	requireNonCDRuntimeKey(t, parsed.PublicSensitiveSurfaceGuard.AllowedPublicNonCDRuntime, "RIIDO_AI_SERVER_AGENT_PROFILE_THUMBNAIL_UPLOAD_EXPIRES_SECONDS", "not a deploy/smoke GitHub configuration key")
	requireNonCDRuntimeKey(t, parsed.PublicSensitiveSurfaceGuard.AllowedPublicNonCDRuntime, "RIIDO_AI_SERVER_AGENT_PROFILE_THUMBNAIL_S3_ENDPOINT", "not a deploy/smoke GitHub configuration key")
